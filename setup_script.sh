...
sui client call --package $PACKAGEID --module base_nft --function transfer_publisher_object --args $PUBLISHERID_nft $ADMIN --gas-budget 3038988
sui client call --package $PACKAGEID --module base_nft --function transfer_publisher_object --args $PUBLISHERID_gop_nft $ADMIN --gas-budget 3038988
sui client call --package $PACKAGEID --module base_nft --function transfer_publisher_object --args $PUBLISHERID_gap_nft $ADMIN --gas-budget 3038988
sui client call --package $PACKAGEID --module base_nft --function transfer_publisher_object --args $PUBLISHERID_trophy_nft $ADMIN --gas-budget 3038988
echo "transfer publisher object completed successfully"
sui client call --package $PACKAGEID --module base_nft --function transfer_upgrade_object --args $UPGRADEID $ADMIN --gas-budget 3038988
...
sui client call --package $PACKAGEID --module base_nft --function transfer_display_object --type-args "$PACKAGEID::nft::ArtfiNFT" --args $NFT_DISPLAY $ADMIN --gas-budget 3038988
sui client call --package $PACKAGEID --module base_nft --function transfer_display_object --type-args "$PACKAGEID::gop::GOPNFT" --args $GOP_NFT_DISPLAY $ADMIN --gas-budget 3038988
sui client call --package $PACKAGEID --module base_nft --function transfer_display_object --type-args "$PACKAGEID::gap::GAPNFT" --args $GAP_NFT_DISPLAY $ADMIN --gas-budget 3038988
sui client call --package $PACKAGEID --module base_nft --function transfer_display_object --type-args "$PACKAGEID::trophy::TrophyNFT" --args $TROPHY_NFT_DISPLAY $ADMIN --gas-budget 3038988
